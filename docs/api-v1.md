...
- **Канал:** `private-chat.{chatId}` — авторизация через `channels.php` (роль admin/moderator и право view на чат).
- **События:** `NewChatMessage`, `UserTyping` (если реализовано на бэкенде).
